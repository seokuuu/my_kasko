...
import { 사용자관리_고객사관리_fields, 사용자관리_고객사관리_fields_Cols } from '../../../constants/fields'
...
const Client = ({}) => {
  ...
  // ✅필드이름 설정(col)
  const 테이블필드 = useRef(사용자관리_고객사관리_fields_Cols)
  ...
  useEffect(() => {
    ...
    if (Array.isArray(getData)) {
      setGetRow(add_element_field(getData, 사용자관리_고객사관리_fields))
    }
  }, [isSuccess])
