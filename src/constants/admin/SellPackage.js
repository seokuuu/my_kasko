...
export const packageDispatchFieldsCols = [
  ...
  { headerClass:'custom-header-style',cellStyle: { borderRight: '1px solid #c8c8c8', textAlign: 'center' },field: '순번', minWidth: 60 },
  {
    headerClass:'custom-header-style',
    field: '수정',cellStyle: { borderRight: '1px solid #c8c8c8', textAlign: 'center' },
    maxWidth: 90,
  ...
  { headerClass: 'custom-header-style', cellStyle: { borderRight: '1px solid #c8c8c8', textAlign: 'center' },field: '패키지 이름', minWidth: 100,},
  { headerClass: 'custom-header-style', cellStyle: { borderRight: '1px solid #c8c8c8', textAlign: 'center' },field: '패키지 번호', minWidth: 110,  
  ...
  { headerClass: 'custom-header-style', cellStyle: { borderRight: '1px solid #c8c8c8', textAlign: 'center' },field: '경매 번호', minWidth: 100 },
  { headerClass: 'custom-header-style', cellStyle: { borderRight: '1px solid #c8c8c8', textAlign: 'center' },field: '판매 구분', minWidth: 100 },
  { headerClass: 'custom-header-style', cellStyle: { borderRight: '1px solid #c8c8c8', textAlign: 'center' },field: '판매 유형', minWidth: 100 },
  { headerClass: 'custom-header-style', cellStyle: { borderRight: '1px solid #c8c8c8', textAlign: 'center' },field: '패키지 경매&판매 시작가', minWidth: 200 },
  { headerClass: 'custom-header-style', cellStyle: { borderRight: '1px solid #c8c8c8', textAlign: 'center' },field: '중량', minWidth: 100 },
  ...
  { headerClass: 'custom-header-style', cellStyle: { borderRight: '1px solid #c8c8c8', textAlign: 'center' },field: '경매 상태', minWidth: 100 },
  { headerClass: 'custom-header-style', cellStyle: { borderRight: '1px solid #c8c8c8', textAlign: 'center' },field: '최종 수정자', minWidth: 100 },
  { headerClass: 'custom-header-style', cellStyle: { borderRight: '1px solid #c8c8c8', textAlign: 'center' },field: '최종 수정 일자', minWidth: 100 },
]
...
export const packageProductsDispatchFieldsCols = [
  { headerClass:'custom-header-style',cellStyle: { borderRight: '1px solid #c8c8c8', textAlign: 'center' },field: '', maxWidth: 50, checkboxSelection: checkboxSelection, headerCheckboxSelection: headerCheckboxSelection },
  { headerClass:'custom-header-style',cellStyle: { borderRight: '1px solid #c8c8c8', textAlign: 'center' },field: '순번',cellStyle: { borderRight: '1px solid #c8c8c8', textAlign: 'center' }, minWidth: 100 },
  { headerClass:'custom-header-style',cellStyle: { borderRight: '1px solid #c8c8c8', textAlign: 'center' },field: '패키지 번호',cellStyle: { borderRight: '1px solid #c8c8c8', textAlign: 'center' }, minWidth: 100 },
