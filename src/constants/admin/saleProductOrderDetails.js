...
export const saleProductOrderDetailsCols = [
	...
	{ field: '고객사명', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: '고객코드', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: '제품번호', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: '프로넘 (ProNo.)', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	...
	{ field: '변경요청 목적지명', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: '변경요청 목적지 주소', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: '변경요청 목적지 연락처', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	...
	{ field: '제품등급', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: '정척여부', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: '유찰횟수', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: '제품 낙찰단가(원/톤)', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: '낙찰총단가(원/톤)', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: '제품공급가(원/톤)', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: '제품부가세(원/톤)', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: '제품금액 (VAT포함)', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: '기본 운임단가(원/톤)', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: '할증 운임단가(원/톤)', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: '운임 총단가 운반비공급가(원/톤)', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: '운반비부가세(원/톤)', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: '운반비 금액 (VAT포함)', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: '총공급가(원/톤)', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: '총부가세(원/톤)', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: '합계금액(원/톤)', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: '두께', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: '폭', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: '길이', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: '중량', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: '규격약호', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: 'TS', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: 'YP', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: 'C%', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: 'EL', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: 'SI', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: 'MN', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: 'P', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: 'S', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: '여재원인', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: '여제원인명1', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: '용도코드', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: '용도명', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	...
	{ field: '매입 기본운임단가(원/톤)', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: '매입 할증운임단가(원/톤)', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: '매입 운임총단가', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: '매입 운반비공급가(원/톤)', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: '매입 운반비부가세(원/톤)', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: '매입 운반비 금액 (VAT포함)', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	...
	{ field: '카스코 낙찰가', minWidth: 100, cellStyle: { 'text-align': 'center' } },
