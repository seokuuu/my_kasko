...
export const singleProductListFieldCols = [
	...
	{ field: '상시판매 주문 일자', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	...
	{ field: '등록 일자', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: '입고상태', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: '매입 처', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: '제조사', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: '경매등록상태', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	...
	{ field: '매입가', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: '경매시작단가 (시작가)', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: '낙찰 상태', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	...
	{ field: '운임 총단가', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: '운반비공급가(원/톤)', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	...
	{ field: '판매제외 사유', minWidth: 100, cellStyle: { 'text-align': 'center' } },
	{ field: '클레임 진행상태', minWidth: 100, cellStyle: { 'text-align': 'center' } },
