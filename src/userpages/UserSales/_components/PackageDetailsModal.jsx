...
import { PROD_CATEGORY, getUserPackageDetailsFieldsCols, getUserPackageProductFieldsCols, userPackageDetailsField } from '../../../constants/user/product'
...
const PackageDetailsModal = ({ packageNumber, action, onClose }) => {
  ...
  } = useTableSearchParams({ ...initialSearchParams, packageNumber: packageNumber });
  // API
            ...
            />
              {/* 패키지 상세 액션 */}
              {
                ...
                <Bottom style={{ display: 'flex',marginTop: 30 }}>
                  <AddCartButton category={PROD_CATEGORY.package} products={selectedData} buttonType={CART_BUTTON_TYPE.simple} />
                  <AddOrderButton category={PROD_CATEGORY.package} totalWeight={selectedWeight} products={selectedData} buttonType={ORDER_BUTTON_TYPE.simple} />
                </Bottom>
              }
            </TableContianer>
          </FilterContianer>
