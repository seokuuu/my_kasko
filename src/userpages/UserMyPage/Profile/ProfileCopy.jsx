...
import { ErrorMsg } from '../../../pages/User/SignUp/style'
import { FlexInputBtn } from '../../../pages/UserManage/Client/ClientEditModal'
import useAlert from '../../../store/Alert/useAlert'
import DownloadButton from '../../../utils/DownloadButton'
// import { ErrorMsg } from '../../User/SignUp/style'
// import { FlexInputBtn } from './ClientEditModal'

const ProfileCopy = ({ setEditModal, id }) => {
	...
	return (
		<>
			<OnePageFlexContainer>
				...
				<ModalContainerSubC onSubmit={handleSubmit(id ? onUpdate : onSubmit)}>
					<MainContainer>
						...
						<Right style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
							...
							<FlexPart style={{ marginBottom: '5px' }}>
								...
								<FlexContent>
									{id ? (
										<DownloadButton
											fileUrl={getValues('bankbookFileUrl')}
											fileName={getValues('bankbookOriginalName')}
										/>
									) : (
										<TxtDivNoborder className="no-border" style={{ border: '1px solid #000000' }}>
